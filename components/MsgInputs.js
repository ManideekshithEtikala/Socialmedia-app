...
export default function MsgInputs() {
  return (
    <main className="flex w-full border-b border-gray-200 space-x-3 mb-2">
      <img src="https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_1280.png" alt="user profile" className="w-10 h-10 rounded-full  mx-2" />
